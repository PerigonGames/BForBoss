    ...
    public class EnemySpawner : MonoBehaviour
    {
        ...
        public void Initialize(LifeCycleManager lifeCycleManager)
        {
            ...
            if (_burstInitialSpawn)
            {
                ...
                {
                    //_lifeCycleManager.AddEnemyAgent(_pool.Get(), Release);
                }
            }
            else
            {
       ...
       {
           _pool = new ObjectPool<LifeCycleBehaviour>(() => GenerateEnemy(_enemyAgent),
                (enemy) =>
                {
        ...
        private void Release(LifeCycleBehaviour behaviour)
        {
        ...
        private LifeCycleBehaviour GenerateEnemy(LifeCycleBehaviour enemyAgent)
        {
